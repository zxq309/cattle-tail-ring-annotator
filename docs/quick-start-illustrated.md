# COWMATA Annotator 新手图文操作手册 3.4.1

操作顺序：准备数据 → 审查归类 → 标注保存 → 复核导出。

前六页新增交互截图来自 3.4.1 实际 Windows 窗口，彩条视频、九轴与标签均为隔离演示数据，不作研究真值。后续通用操作页沿用 3.3 系列实际截图；数据整理和标签调整以本版新增页为准。

## 01 启动便携版与空格播放

阶段：3.4.1 使用与交互

![启动便携版与空格播放](../assets/screenshots/manual-332/../manual-341/01-keyboard.png)
...
![开始与结束不能是同一时刻](../assets/screenshots/manual-332/../manual-341/02-zero-time.png)
...
![选中最新标签并直接拖动](../assets/screenshots/manual-332/../manual-341/03-latest-drag.png)
...
![选择对应人工标签：下一步怎么做](../assets/screenshots/manual-332/../manual-341/04-algorithm.png)
...
![按批次类别整理新数据](../assets/screenshots/manual-332/../manual-341/05-organization.png)
...
![保存、导出与再检查](../assets/screenshots/manual-332/../manual-341/06-export.png)
